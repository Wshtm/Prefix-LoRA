...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_prefix_tuning', type=str, default='yes', help='')
    parser.add_argument('--use_lora', type=str, default='yes', help='')
    args = parser.parse_args()
    print(f"useP0:{args.use_prefix_tuning}")
    print(f"useL0:{args.use_lora}")
    ...
    if args.do_train == 'yes':
        COMMANDLINE = 'python finetune.py ' \
                      ...
                      '--train_batch_size {} ' \
                      '--eval_batch_size {} ' \
                      '--num_train_epochs {} '.format(args.use_prefix_tuning,args.use_lora,OLD_MODEL, Model_FILE, data_dir, args.tuning_mode, args.preseqlen, args.label_smoothing, args.use_deep,
        ...
        if args.tuning_mode == 'finetune':
            ...
            COMMANDLINE = 'python finetune.py ' \
                          ...
                          '--eval_batch_size {} ' \
                          '--length_penalty {} ' \
                          '--num_train_epochs {} '.format(args.use_prefix_tuning,args.use_lora,args.finetune_model_path, Model_FILE, data_dir,
            ...
            COMMANDLINE = 'python finetune.py ' \
                          ...
                          '--seed {} ' \
                          '--length_penalty {} ' \
                          '--num_train_epochs {} '.format(args.use_prefix_tuning,args.use_lora,OLD_MODEL, args.prefix_model_path, Model_FILE, data_dir,
                                                          args.tuning_mode, args.preseqlen, args.use_deep,
